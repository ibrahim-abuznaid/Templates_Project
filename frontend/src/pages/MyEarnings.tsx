          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-orange-900">
                ${pendingSummary?.total_amount?.toFixed(2) || '0.00'}
              </p>
        ...
        <div className="card bg-gradient-to-br from-green-50 to-green-100 border-green-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-green-900">${totalEarned.toFixed(2)}</p>
            ...
            <div>
              ...
              <p className="text-3xl font-bold text-blue-900">
                ${pendingSummary?.item_count > 0 
                  ? (pendingSummary.total_amount / pendingSummary.item_count).toFixed(2) 
                  : '0.00'}
              </p>
